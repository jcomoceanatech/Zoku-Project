...
define(['N/ui/serverWidget', '../Library/zk_xm_library','N/search','N/record'], function(serverWidget, libHelper,search,record) {
    ...
    function beforeSubmit(scriptContext) {
        ...
        if(newRecord.getValue({fieldId: "custrecord_zk_pa_to_process_so"})) {
            ...
            if(intSalesOrder) {
                newRecord.setValue({fieldId: libHelper.PRODUCT_ALLOCATION_RECORD.SALES_ORDER, value: intSalesOrder});
        ...
        if(newRecord.getValue({fieldId: libHelper.PRODUCT_ALLOCATION_RECORD.SALES_ORDER})) {
            ...
            if(flNewAllocationQuantity && flOldAllocationQuantity) {
                if(flOldAllocationQuantity != flNewAllocationQuantity) {
                    ...
                    currLine.setCurrentSublistValue({sublistId:"item", fieldId:"custcol_discount_amount", value: flDiscountAmount});
    ...
    function createSalesOrder(objProductAllocation, intProductAllocationId) {
        ...
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'item', line: 0, value: objProductAllocation.advanceitem });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'department', line: 0, value: objProductAllocation.department });
        ...
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'department', line: 1, value: objProductAllocation.department });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'class', line: 1, value: objProductAllocation.class });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'price', line: 1, value: objProductAllocation.pricelevel });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'quantity', line: 1, value: parseFloat(objProductAllocation.custrecord_zk_pa_allocated_quantity) });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'custcol_original_rate', line: 1, value: fetchItemRate });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'rate', line: 1, value: flDiscountedRate });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'custcol_discount_percent', line: 1, value: flDiscount });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'custcol_discount_amount', line: 1, value: flDiscountAmount * parseFloat(objProductAllocation.custrecord_zk_pa_allocated_quantity)  });

        var currentLine = createSalesOrder.insertLine({ sublistId: 'item', line: 2 });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'item', line: 2, value: objProductAllocation.advanceitem });
        currentLine.setSublistValue({ sublistId: 'item', fieldId: 'department', line: 2, value: objProductAllocation.department });
    ...
    function createInventoryStatusChange(context) {
        ...
        recInventoryStatusChange.setValue({ fieldId: 'location', value: newRecord.getValue('custrecord_zk_pa_location') });
        ...
        currentLine.setCurrentSublistValue({ sublistId: 'inventory', fieldId: 'item', value: newRecord.getValue('custrecord_zk_pa_item') });
        currentLine.setCurrentSublistValue({ sublistId: 'inventory', fieldId: 'quantity', value: newRecord.getValue('custrecord_zk_pa_allocated_quantity') });
        ...
        if(itemLookupField.isserialitem === true || itemLookupField.islotitem === true) {
            var inventoryDetailRecord = currentLine.getCurrentSublistSubrecord({ sublistId: 'inventory', fieldId: 'inventorydetail' });
            ...
            if(arrAvailableInventoryNumbers.length != 0) {
                for (var intIndex = 0; intIndex < arrAvailableInventoryNumbers.length; intIndex++) {
                    ...
                    inventoryDetailRecord.setCurrentSublistValue({ sublistId: 'inventoryassignment', fieldId: 'issueinventorynumber', value: arrAvailableInventoryNumbers[intIndex] });
                    inventoryDetailRecord.setCurrentSublistValue({ sublistId: 'inventoryassignment', fieldId: 'quantity', value: 1 });
